...
export const sendStatuses: Record<string, SendStatusRecord> = {
  ...
  [entryId("cust-ledger-01", "cast-a", d)]: { status: "unsent" },
  [entryId("cust-ledger-02", "cast-a", d)]: { status: "unsent" },
  [entryId("cust-ledger-03", "cast-a", d)]: { status: "unsent" },
  [entryId("cust-ledger-04", "cast-a", d)]: { status: "unsent" },
  [entryId("cust-ledger-05", "cast-a", d)]: { status: "unsent" },
  [entryId("cust-ledger-06", "cast-a", d)]: { status: "unsent" },
  [entryId("cust-ledger-07", "cast-a", d)]: { status: "unsent" },
  ...
  [entryId("cust-ledger-08", "cast-a", d1)]: sent("ボトル移管", "2026-05-31T00:05:00.000Z"),
  [entryId("cust-ledger-09", "cast-a", d1)]: noLine("S・Y", "2026-05-31T00:10:00.000Z"),
  [entryId("cust-ledger-10", "cast-a", d1)]: noContact("2026-05-31T00:15:00.000Z"),
  ...
  [entryId("cust-ledger-11", "cast-a", d2)]: sent("常連未登録", "2026-05-29T23:58:00.000Z"),
  [entryId("cust-ledger-12", "cast-a", d2)]: noLine("海外客", "2026-05-30T00:02:00.000Z"),
};
